...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>LINK.LAST_TRACKED</code>.
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_TRACKED = createField(DSL.name("LAST_TRACKED"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.URL_INDEX);
    }
