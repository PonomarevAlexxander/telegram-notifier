...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record3<Integer, String, OffsetDateTime> {
     ...
     */
    public void setLastTracked(@NotNull OffsetDateTime value) {
        set(2, value);
    }
    ...
    public LinkRecord value3(@NotNull OffsetDateTime value) {
        setLastTracked(value);
        return this;
    }

    @Override
    @NotNull
    public LinkRecord values(@Nullable Integer value1, @NotNull String value2, @NotNull OffsetDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    public LinkRecord(@Nullable Integer id, @NotNull String url, @NotNull OffsetDateTime lastTracked) {
        super(Link.LINK);

        setId(id);
        setUrl(url);
        setLastTracked(lastTracked);
    ...
    public LinkRecord(edu.java.scrapper.domain.jooq.tables.pojos.Link value) {
        ...
        if (value != null) {
            setId(value.getId());
            setUrl(value.getUrl());
            setLastTracked(value.getLastTracked());
            resetChangedOnNotNull();
        }
    }
}
